...
|`faker` (Deno module)       | `faker` (fake data generator) | ✔ ( ported to work with Deno) [link](https://deno.land/x/deno_faker@v1.0.0/build/src/docs.md?source=) |
| `react` (Deno module)          | `react` (JavaScript library for building user interfaces) | 🍋 (use FreshJS to work with Deno) |
| `axiod` (Deno module)          | `axios` (HTTP request library) | ✔ (adapted to work with Deno) [link](https://deno.land/x/axiod@0.26.2) |
